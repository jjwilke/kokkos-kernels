...
FUNCTION(TRIBITS_ADD_EXECUTABLE_AND_TEST EXE_NAME)
  ...
  SET(oneValueArgs PASS_REGULAR_EXPRESSION FAIL_REGULAR_EXPRESSION ENVIRONMENT TIMEOUT CATEGORIES ADDED_TESTS_NAMES_OUT ADDED_EXE_TARGET_NAME_OUT NUM_MPI_PROCS)
  SET(multiValueArgs SOURCES ARGS)

  CMAKE_PARSE_ARGUMENTS(PARSE "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  TRIBITS_ADD_EXECUTABLE(${EXE_NAME} TESTONLY ADDED_EXE_TARGET_NAME_OUT TEST_NAME 
...
FUNCTION(TEST_INCLUDE_DIRECTORIES THE_TARGET) #it's pronounced 'tarjzay'
  ...
  TARGET_INCLUDE_DIRECTORIES(${THE_TARGET} PRIVATE ${PARSE_DEFAULT_ARGS})
ENDFUNCTION()
