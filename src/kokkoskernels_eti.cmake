...
MACRO(KOKKOSKERNELS_ETI PREFIX FUNCTION_NAME SUBFOLDER)
  STRING(TOUPPER ${FUNCTION_NAME} NAME_UC)
  STRING(TOUPPER ${SUBFOLDER} SUBFOLDER_UC)
  IF (KOKKOSKERNELS_ENABLE_${SUBFOLDER_UC})
    KOKKOSKERNELS_GENERATE_ETI(${PREFIX}_${FUNCTION_NAME} ${SUBFOLDER} ${ARGN})
  ENDIF()
ENDMACRO(KOKKOSKERNELS_ETI)
